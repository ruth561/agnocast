...
class TopicEchoAgnocastVerb(EchoVerb):
    """Output messages from a topic including Agnocast."""
    ...
    def add_arguments(self, parser, cli_name):
        ...
        parser.description = (
            ...
            'then the standard ros2 topic echo output begins.'
        )
        parser.add_argument(
            '--bridge-timeout',
    ...
    def main(self, *, args):
        ...
        print("Bridge is ready. Starting echo...")

        # Step 2: Hand off to the standard ros2 topic echo implementation.
